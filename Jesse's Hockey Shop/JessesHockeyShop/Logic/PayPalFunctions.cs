...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (JessesHockeyShop.Logic.ShoppingCartActions myCartOrders = new JessesHockeyShop.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      JessesHockeyShop.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
